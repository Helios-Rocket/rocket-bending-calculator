...
for section_idx = 1:num_sections
    ...
    if (isfield(section,'subcomponents') && ((isfield(section.subcomponents, 'trapezoidfinset') || isfield(section.subcomponents, 'freeformfinset'))))
        ...
        elseif isfield(subcomponents, 'freeformfinset')
            ...
            fins = struct( ...
                'xPt', [section.subcomponents.freeformfinset.finpoints.point.xAttribute], ...
                'yPt', [section.subcomponents.freeformfinset.finpoints.point.yAttribute], ...
                'R_body', section.forerad, ...
                'R_ref',  R_ref, ...
                'n_fins', finset.fincount);
            ...
            if strcmp(finset.axialoffset.methodAttribute, 'bottom')
                Cp_fins = Cp_fins  + section.length - tail([section.subcomponents.freeformfinset.finpoints.point.xAttribute]',1);
                x_pos = x_pos + section.length - tail([section.subcomponents.freeformfinset.finpoints.point.xAttribute]',1);
            end
            ...
            aero_sections{aero_section_idx} = struct( ...
                ...
                'id', finset.id, ...
                'x', x_pos, ...
                'length', tail([section.subcomponents.freeformfinset.finpoints.point.xAttribute]',1), ...
                'd', 0, ...
                'D', inf);
            aero_section_idx = aero_section_idx + 1;
        end
